...
condor_compile gfortran -w  -O3 -o mercury7_removenamereducer frag_remove_name_reduction_scheme.f90

echo "Now not for Condor"
gfortran -w  -O3 -g -o mercury7_nocondor_removenamereducer frag_remove_name_reduction_scheme.f90
