...
!==============================================================================
    module frag_interfaces_notidal
!
    interface
...
!
    end module frag_interfaces_notidal
!==============================================================================
    module interfaces
!
    interface
...
!
    ...
    use frag_interfaces_notidal, only: calc_relative_coords, calc_impact_geometry, &
...
!
    ...
    use interfaces, only: cross_product
    use frag_interfaces_notidal, only: calc_relative_coords, &
...
!
    use constants;    use globals;    use frag_globals
    use frag_interfaces_notidal, only: calc_qstar, calc_remnant_mass!, &
...
!
    use constants;    use globals
    use frag_interfaces_notidal, only: calc_relative_coords, calc_absolute_coords, &
